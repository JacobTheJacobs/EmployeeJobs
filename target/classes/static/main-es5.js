(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddComponent = /** @class */ (function () {
                function AddComponent(service, location) {
                ...
                AddComponent.prototype.getJobs = function () {
                    var _this = this;
                    this.service.getAllJobs().subscribe(function (successResponse) { _this.jobs = successResponse; }, function (error) { return console.log(error); });
                };
                AddComponent.prototype.add = function (employee) {
                    var _this = this;
                    this.service.add(this.employee).subscribe(function (successResponse) { _this.back(); }, function (error) { return console.log(error); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CompanyService = /** @class */ (function () {
                ...
                CompanyService.prototype.getAllEmployees = function () {
                    return this.http.get("http://localhost:8090/employees");
                };
                CompanyService.prototype.getAllJobs = function () {
                    return this.http.get("http://localhost:8090/employees/job");
                };
                CompanyService.prototype.getEmployeeById = function (id) {
                ...
                CompanyService.prototype.add = function (employee) {
                    return this.http.post("http://localhost:8090/employees", employee);
                };
                CompanyService.prototype.edit = function (id, value) {
                    return this.http.put("http://localhost:8090/employees/" + id, value);
                };
                CompanyService.prototype.addJob = function (job) {
                    return this.http.post("http://localhost:8090/employees/job", job);
                };
                CompanyService.prototype.deleteJob = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditJobComponent = /** @class */ (function () {
                function EditJobComponent(service, location, toastr) {
                    this.service = service;
                    this.location = location;
                    this.toastr = toastr;
                ...
                EditJobComponent.prototype.getJobs = function () {
                    var _this = this;
                    this.service.getAllJobs().subscribe(function (data) { return (_this.allJobs = data); }, function (error) { return console.log(error); });
                };
                EditJobComponent.prototype.addJob = function (job) {
                    this.service.addJob(this.job).subscribe(function (response) { return console.log(response); }, function (error) { return console.log(error); });
                };
                EditJobComponent.prototype.back = function () {
                    this.location.back();
                };
                EditJobComponent.prototype.getId = function (id) {
                    this.id = id;
                    this.delete(id);
                };
                EditJobComponent.prototype.delete = function (id) {
                    var _this = this;
                    this.service.deleteJob(id).subscribe(function (data) { console.log(data); _this.getJobs(); _this.showToasterSuccees(); }, function (error) {
                        _this.showToasterError(), console.log(error);
                    });
                };
                EditJobComponent.prototype.showToasterError = function () {
                    this.toastr.error("Cant delete Job is assigned to employee");
                };
                EditJobComponent.prototype.showToasterSuccees = function () {
                    this.toastr.success("Job was deleted");
                };
                return EditJobComponent;
            }());
            EditJobComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditComponent = /** @class */ (function () {
                function EditComponent(service, route, location) {
                    this.service = service;
                    this.route = route;
                    this.location = location;
                    this.employee = new _employee__WEBPACK_IMPORTED_MODULE_2__["Employee"]();
                ...
                EditComponent.prototype.getAllRoles = function () {
                    var _this = this;
                    this.service.getAllJobs().subscribe(function (response) { _this.jobs = response; }, function (error) { return console.log(error); });
                };
                EditComponent.prototype.getEmployeeForEdit = function () {
                    var _this = this;
                    this.id = this.route.snapshot.params.id;
                    if (this.id) {
                        this.service.getEmployeeById(this.id).subscribe(function (response) { _this.employee = response; }, function (error) { return console.log(error); });
                    }
                };
                EditComponent.prototype.edit = function (id, form) {
                    var _this = this;
                    this.service.edit(this.employee, id).subscribe(function (successResponse) { _this.location.back(); }, function (error) { return console.log(error); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                ...
                HomeComponent.prototype.getEmployees = function () {
                    var _this = this;
                    this.service.getAllEmployees().subscribe(function (data) { return _this.employees = data; }, function (error) { return console.log(error); });
                };
                HomeComponent.prototype.ngOnInit = function () {
                    this.getEmployees();
                };
                HomeComponent.prototype.getId = function (id) {
                    this.id = id;
                    this.delete(id);
                };
                HomeComponent.prototype.delete = function (id) {
                    ...
                    this.service.delete(id)
                        .subscribe(function (data) { console.log(data); _this.getEmployees(); }, function (error) { return alert(error); });
                };
